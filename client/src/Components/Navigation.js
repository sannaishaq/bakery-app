  ...
  return (
     ...
     <div className="nav">
         <Navbar collapseOnSelect fixed= 'top' expand= 'sm' bg='light' variant='light'>
                    <Navbar.Brand>
                    <img src={'https://res.cloudinary.com/djbbs3mk3/image/upload/v1652196868/Cakes/ZAKS_JPEG_FILE_RGB_a1uce2.jpg'} width="300px" height="55px" />{' '}
                    </Navbar.Brand>
            <Container>
                ...
                <Navbar.Collapse id='responsive-navbar-nav'>
                    <Nav>
                        ...
                        <NavDropdown title="Products" href="/products">
